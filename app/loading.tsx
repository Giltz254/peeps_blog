...
const Loading = () => {
  return (
    <div className="w-full h-[calc(100vh)] flex items-center justify-center bg-muted flex-col gap-2">
      ...
      <span className="text-sm font-medium text-secondary-foreground capitalize">Loading...</span>
    </div>
  );
};
